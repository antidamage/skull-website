        ...
        <div className="flex block">
            <div className="">
                <p className="ps-10 tracking-tight font-bold text-2xl text-nowrap flex-nowrap">Adeline Cook<br />
                    ...
                    <br />
                    <a className="hover:text-emerald-400 text-nowrap flex-nowrap" href="tel:+64212700222">
                        +64 21 2700 222
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 inline ml-5">
                    ...
                    <a href="https://discord.gg/RAEJEhW" className="hover:text-emerald-600 flex flex-nowrap align-baseline" target="_blank">
                        Discord
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 inline ml-5 mt-1">
