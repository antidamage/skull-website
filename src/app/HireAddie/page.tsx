        ...
        <div className="landscape:inline-flex landscape:justify-end portrait:p-10">
            <div className="landscape:inline-flex landscape:mt-2">
                ...
                <p className={`max-w-prose text-pretty ps-10 tracking-widest portrait:text-xs landscape:text-s font-thin ${poppins.className}`}>
                    ...
                    <br /><br />
                    <Link className="border rounded p-2 border-emerald-400 flex flex-nowrap align-baseline portrait:text-xs landscape:text-s font-bold hover:text-emerald-200" href="https://docs.google.com/document/d/1TZotQfqw4h_oAkPLhlSFk2TJ6eQkrNEJ1GGCGape8cA/edit?usp=sharing" target="_blank">
                    ...
                    <br />
                    <Link className="border rounded p-2 border-emerald-400 flex flex-nowrap align-baseline portrait:text-xs landscape:text-s font-bold hover:text-emerald-400" href="https://github.com/antidamage/skull-website" target="_blank">
