...
export default function HireAddie({ }: {}) {
    return (<>
        ...
        <p className={`max-w-prose text-pretty ps-10 tracking-widest text-s font-thin ${poppins.className}`}>
            ...
            <br /><br />
            <a className="flex flex-nowrap align-baseline text-lg font-bold" href="https://docs.google.com/document/d/1TZotQfqw4h_oAkPLhlSFk2TJ6eQkrNEJ1GGCGape8cA/edit?usp=sharing" target="_blank">
                Adeline Cook - Curriculum Vitae
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 flex flex-nowrap ml-2 text-nowrap">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15M9 12l3 3m0 0 3-3m-3 3V2.25" />
                </svg>
            </a>
            <br />
            <a className="flex flex-nowrap align-baseline text-base font-bold" href="https://github.com/antidamage/skull-website" target="_blank">
