...
export default function HireAddie({ }: {}) {
    return (<>
        ...
        <p className={`max-w-prose text-pretty ps-10 tracking-widest text-s font-thin ${poppins.className}`}>
            ...
            <br />
            <a className="flex flex-nowrap align-baseline text-base font-bold" href="https://github.com/antidamage/skull-website">
                This website uses Next.js and Tailwind. View it on Github
