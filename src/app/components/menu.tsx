...
export default function Menu() {
    return <nav className="flex items-center mx-auto">
        <div className={`flex text-xl tracking-widest shadow-sm bg-slate-800 space-x-10 portrait:inline landscape:text-nowrap pe-5 ps-5 portrait:object-contain ${poppins.className}`}>
